                        ...
                        <table class="table datatable">
                            ...
                            @foreach ($accounts as $account)
                                <tr class="font-semibold">
                                    ...
                                    <td class="p-0">{{  $account->bank_name}}</td>
                                    <td class="p-0">{{  $account->account_number}}</td>
                                    <td class="p-0">{{  $account->currency->name}}</td>
                                    <td class="p-0">{{  $account->opening_balance . " " .$account->currency->symbol }}</td>
                                    <td class="p-0">{{  $account->contact_number}}</td>
                                    <td class="p-0">{{  $account->bank_address}}</td>
