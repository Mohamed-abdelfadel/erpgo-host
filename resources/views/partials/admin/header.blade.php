                ...
                <div class="header-wrapper">
                    <div class="me-auto dash-mob-drp">
                        ...
                        <span class="theme-avtar">
                            <img alt="#"
                                 src="{{ !empty($users->avatar) ? asset("storage/uploads/avatar/$users->avatar")   : asset("storage/avatar/avatar.png") }}"
                        ...
                        <ul class="list-unstyled">
                            @if( \Auth::user()->type !='client' && \Auth::user()->type !='super admin' )
                                <li class="dropdown dash-h-item drp-notification">
                                    <a class="dash-head-link arrow-none me-0" href="{{ url('chats') }}"
                                       aria-haspopup="false"
                                       aria-expanded="false">
                                        <i class="ti ti-brand-hipchat"></i>
                                        <span
                                            class="bg-danger dash-h-badge message-toggle-msg  message-counter custom_messanger_counter beep"> {{ $unseenCounter }}<span
                                                class="sr-only"></span>
                            </span>
                                    </a>
                                </li>
