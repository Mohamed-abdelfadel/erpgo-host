            ...
            <div class="row">
                <div class="col-xxl-7">
                    <div class="row">
                                        ...
                                        <table class="table">
                                            ...
                                            @forelse($bankAccountDetail as $bankAccount)
                                                <tr class="font-style">
                                                    ...
                                                    <td class="p-0">{{  $bankAccount->bank_name}}</td>
                                                    <td class="p-0">{{  $bankAccount->account_number}}</td>
                                                    <td class="p-0">{{  $bankAccount->currency->name}}</td>
                                                    <td class="p-0">{{  $bankAccount->opening_balance . " " .$bankAccount->currency->symbol }}</td>
                                                </tr>
                                            @empty
                                                <tr>
                                                    <td colspan="4">
                        ...
                        <div class="col-xxl-12">
                            @if(!Auth::user()->can('show banking dashboard'))
                                <div class="card">
                                    <div class="card-header">
                            ...
                            @if(Auth::user()->can('show banking dashboard'))
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="mt-1 mb-0">{{__('Banking Transactions')}}</h5>
                                    </div>
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table class="table">
                                                ...
                                                @forelse($transactions as $transaction)
                                                    ...
                                                    <tr class="font-semibold">
                                                        ...
                                                        <td class="p-0">{{$transaction->SenderBankAccount()->holder_name . " -  " . $transaction->SenderBankAccount()->currency->name}}</td>
                                                        <td class="p-0">{{$transaction->ReceiverBankAccount()->holder_name . " -  " . $transaction->ReceiverBankAccount()->currency->name}}</td>
                                                        <td class="p-0">{{$transaction->debit_amount  . " " . $transaction->SenderBankAccount()->currency->symbol }}</td>
                                                        <td class="p-0">{{$transaction->credit_amount  . " " . $transaction->ReceiverBankAccount()->currency->symbol }}</td>
                                                        <td class="p-0">{{$transaction->rate}}</td>
                                                        <td class="p-0">{{$transaction->description}}</td>
                                                        <td class="p-0">
                                                ...
                                                @forelse($recentInvoice as $invoice)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if($invoice->status == 0)
                                                                <span
                                                                    class="p-2 px-3 rounded badge bg-secondary">{{ __(\App\Models\Invoice::$statues[$invoice->status]) }}</span>
                                                            @elseif($invoice->status == 1)
                                                                <span
                                                                    class="p-2 px-3 rounded badge bg-warning">{{ __(\App\Models\Invoice::$statues[$invoice->status]) }}</span>
                                                            @elseif($invoice->status == 2)
                                                                <span
                                                                    class="p-2 px-3 rounded badge bg-danger">{{ __(\App\Models\Invoice::$statues[$invoice->status]) }}</span>
                                                            @elseif($invoice->status == 3)
                                                                <span
                                                                    class="p-2 px-3 rounded badge bg-info">{{ __(\App\Models\Invoice::$statues[$invoice->status]) }}</span>
                                                            @elseif($invoice->status == 4)
                                                                <span
                                                                    class="p-2 px-3 rounded badge bg-success">{{ __(\App\Models\Invoice::$statues[$invoice->status]) }}</span>
                                                            @endif
                                                        </td>
                                                    </tr>
                                                @empty
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            @elseif($bill->status == 4)
                                                                <span
                                                                    class="p-2 px-3 rounded badge bg-success">{{ __(\App\Models\Bill::$statues[$bill->status]) }}</span>
                                                            @endif
                                                        </td>
                                                    </tr>
                                                @empty
