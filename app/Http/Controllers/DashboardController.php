    ...
    public function account_dashboard_index()
    {
        ...
        if (Auth::check()) {
            if (Auth::user()->type == 'super admin') {
                ...
                return redirect()->route('client.dashboard.view');
            } elseif (Auth::user()->type == 'sales-squad') {
                return view('dashboard.sales-squad-dashboard');
            } else {
                if (\Auth::user()->can('show account dashboard')) {
                    ...
                    $data['transactions'] = BankTransfer::query()->get();
                    ...
                    $data['bankAccountDetail'] = BankAccount::query()->get();
