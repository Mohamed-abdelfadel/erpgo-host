                        ...
                        <table class="table datatable">
                            ...
                            <?php $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="font-semibold">
                                    ...
                                    <td class="p-0"><?php echo e($account->bank_name); ?></td>
                                    <td class="p-0"><?php echo e($account->account_number); ?></td>
                                    <td class="p-0"><?php echo e($account->currency->name); ?></td>
                                    <td class="p-0"><?php echo e($account->opening_balance . " " .$account->currency->symbol); ?></td>
                                    <td class="p-0"><?php echo e($account->contact_number); ?></td>
                                    <td class="p-0"><?php echo e($account->bank_address); ?></td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\~Prgoramming\Projects\Laravel\Mini Projects\erpgo - permissions\resources\views/bankAccount/index.blade.php ENDPATH**/ ?>