    ...
    <form method="POST" action="<?php echo e(route('register')); ?>">
        ...
        <div class="">
            <div class="form-group mb-3">
                <label for="gid" class="form-label"><?php echo e(__('Asana user ID')); ?></label>
                <input id="gid" type="text" class="form-control <?php $__errorArgs = ['gid'];
...
unset($__errorArgs, $__bag); ?>" name="gid" value="<?php echo e(old('gid')); ?>" autocomplete="gid" autofocus>
                <?php $__errorArgs = ['gid'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erpgo\resources\views/auth/register.blade.php ENDPATH**/ ?>