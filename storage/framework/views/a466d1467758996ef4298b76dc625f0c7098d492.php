                    ...
                    <div class="m-header main-logo">
                        <a href="#" class="b-brand">
                            ...
                            <?php if($mode_setting['cust_darklayout'] && $mode_setting['cust_darklayout'] == 'on' ): ?>
                                <img
                                    src="<?php echo e(asset('public/logos/gorgov-light.png')); ?>"
                                    alt="<?php echo e(config('app.name', 'ERPGo-SaaS')); ?>" class="logo logo-lg">
                            <?php else: ?>
                                <img
                                    src="<?php echo e(asset('public/logos/gorgov-dark.png')); ?>"
                                    alt="<?php echo e(config('app.name', 'ERPGo-SaaS')); ?>" class="logo logo-lg">
                            <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\backup\erpgo\resources\views/partials/admin/menu.blade.php ENDPATH**/ ?>