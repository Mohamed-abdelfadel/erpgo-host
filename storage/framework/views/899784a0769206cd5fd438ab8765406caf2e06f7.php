                        ...
                        <div class="card text-center">
                            ...
                            <div class="card-body full-card">
                                <div class="img-fluid rounded-circle card-avatar">
                                    <img src="<?php echo e(!empty($client->avatar) ? asset("storage/uploads/avatar/$client->avatar")   : asset("storage/avatar/avatar.png")); ?>"  class="img-user wid-80 rounded-circle">
                                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erpgo\resources\views/clients/index.blade.php ENDPATH**/ ?>