                ...
                <div class="col-6">
                    <div class="list-group-item px-0">
                        <div class="row align-items-center">
                            ...
                            ?>
                            <div class="col-auto text-end add_usr <?php echo e((in_array($user->gid,$usrs)) ? 'selected':''); ?>" data-id="<?php echo e($user->gid); ?>">
                                <button type="button" class="btn mr-3">
                            <span class="btn-inner--visible">
                              <i class="ti ti-<?php echo e((in_array($user->gid,$usrs)) ? 'check' : 'plus'); ?> " id="usr_icon_<?php echo e($user->gid); ?>"></i>
                            </span>
                                    <span class="btn-inner--hidden text-white" id="usr_txt_<?php echo e($user->gid); ?>"><?php echo e((in_array($user->gid,$usrs)) ? __('Added') : __('Add')); ?></span>
                                </button>
                            </div>
                        </div>
                    </div>
