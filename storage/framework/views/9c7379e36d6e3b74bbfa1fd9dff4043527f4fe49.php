...
<nav class="navbar navbar-expand-md navbar-dark default top-nav-collapse">
    <div class="container">
        <a class="navbar-brand bg-transparent" href="">
            ...
            <img src="<?php echo e(asset('public/logos/gorgov-light.png')); ?>" alt="gorgov-logo" width="7%"/>
...
<header id="home" class="bg-primary">
    <div class="container">
        <div class="row align-items-center justify-content-between">
            ...
            <div class="col-sm-5">
                <img
                    src="<?php echo e(asset('public/images/gorgov-1.jpg')); ?>"
                    alt="Gorgov Cover"
...
<section id="dashboard" class="theme-alt-bg dashboard-block">
    <div class="container">
        ...
        <div style="display: flex;justify-content: center;align-items: center;">
            <img
                src="<?php echo e(asset('public/images/gorgov-5.jpg')); ?>"
                alt=""
                width="50%"
...
<section id="dashboard" class="theme-alt-bg dashboard-block">
    <div class="container">
        <div class="row align-items-center justify-content-end mb-5">
            ...
            <div class="col-sm-6">
                <img
                    src="<?php echo e(asset('public/images/gorgov-3.jpg')); ?>"
                    alt="gorgov"
                    class="img-fluid header-img wow animate__fadeInRight rounded"
                    data-wow-delay="0.2s"
                />
        ...
        <div class="row align-items-center justify-content-start">
            <div class="col-sm-6">
                <img
                    src="<?php echo e(asset('public/images/gorgov-4.jpg')); ?>"
                    alt="gorgov"
...
<?php /**PATH C:\xampp\htdocs\backup\erpgo\resources\views/layouts/landing.blade.php ENDPATH**/ ?>