            ...
            <div class="container-fluid pe-2">
                <a class="navbar-brand" href="#">
                    ...
                    <?php if($mode_setting['cust_darklayout'] && $mode_setting['cust_darklayout'] == 'on' ): ?>
                        <img src="<?php echo e(asset('public/logos/gorgov-light.png')); ?>"
                             alt="gorgov"
                             width="7%">

                    <?php else: ?>
                        <img src="<?php echo e(asset('public/logos/gorgov-dark.png')); ?>"
                             alt="gorgov"
                             width="7%">
...
<?php /**PATH C:\xampp\htdocs\backup\erpgo\resources\views/layouts/auth.blade.php ENDPATH**/ ?>