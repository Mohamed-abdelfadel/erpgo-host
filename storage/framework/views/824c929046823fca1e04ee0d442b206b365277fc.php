            ...
            <div class="row">
                <div class="col-xxl-7">
                    <div class="row">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h5><?php echo e(__('Income & Expense')); ?>
                                        ...
                                        <span
                                            class="float-end text-muted"><?php echo e(__('Current Year').' - '.$currentYear); ?></span>
                                    </h5>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tr>
                                                ...
                                                <th> <?php echo e(__('Account Currency')); ?></th>
                                            ...
                                            <?php $__empty_1 = true; $__currentLoopData = $bankAccountDetail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bankAccount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                <tr class="font-style">
                                                    ...
                                                    <td class="p-0"><?php echo e($bankAccount->bank_name); ?></td>
                                                    <td class="p-0"><?php echo e($bankAccount->account_number); ?></td>
                                                    <td class="p-0"><?php echo e($bankAccount->currency->name); ?></td>
                                                    <td class="p-0"><?php echo e($bankAccount->opening_balance . " " .$bankAccount->currency->symbol); ?></td>
                                                </tr>
                        ...
                        <div class="col-xxl-12">
                            <?php if(!Auth::user()->can('show banking dashboard')): ?>
                                <div class="card">
                                    <div class="card-header">
                            ...
                            <?php if(Auth::user()->can('show banking dashboard')): ?>
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="mt-1 mb-0"><?php echo e(__('Banking Transactions')); ?></h5>
                                    </div>
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table class="table">
                                                ...
                                                <?php $__empty_1 = true; $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                    ...
                                                    <tr class="font-semibold">
                                                        ...
                                                        <td class="p-0"><?php echo e($transaction->SenderBankAccount()->holder_name . " -  " . $transaction->SenderBankAccount()->currency->name); ?></td>
                                                        <td class="p-0"><?php echo e($transaction->ReceiverBankAccount()->holder_name . " -  " . $transaction->ReceiverBankAccount()->currency->name); ?></td>
                                                        <td class="p-0"><?php echo e($transaction->debit_amount  . " " . $transaction->SenderBankAccount()->currency->symbol); ?></td>
                                                        <td class="p-0"><?php echo e($transaction->credit_amount  . " " . $transaction->ReceiverBankAccount()->currency->symbol); ?></td>
                                                        <td class="p-0"><?php echo e($transaction->rate); ?></td>
                                                        <td class="p-0"><?php echo e($transaction->description); ?></td>
                                                        <td class="p-0">
                                                            <?php if($transaction->status == 1): ?>
                                                                <span
                                                                    class="status_badge badge bg-primary p-2 px-3 rounded">Success</span>
                                                            <?php else: ?>
                                                                <span
                                                                    class="status_badge badge bg-danger p-2 px-3 rounded">Failed</span>
                                                            <?php endif; ?>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                                    <tr>
                                                        <td colspan="8">
                                                            <div class="text-center">
                                                                <h6><?php echo e(__('No transation found')); ?></h6>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                <?php endif; ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php if($invoice->status == 0): ?>
                                                                <span
                                                                    class="p-2 px-3 rounded badge bg-secondary"><?php echo e(__(\App\Models\Invoice::$statues[$invoice->status])); ?></span>
                                                            <?php elseif($invoice->status == 1): ?>
                                                                <span
                                                                    class="p-2 px-3 rounded badge bg-warning"><?php echo e(__(\App\Models\Invoice::$statues[$invoice->status])); ?></span>
                                                            <?php elseif($invoice->status == 2): ?>
                                                                <span
                                                                    class="p-2 px-3 rounded badge bg-danger"><?php echo e(__(\App\Models\Invoice::$statues[$invoice->status])); ?></span>
                                                            <?php elseif($invoice->status == 3): ?>
                                                                <span
                                                                    class="p-2 px-3 rounded badge bg-info"><?php echo e(__(\App\Models\Invoice::$statues[$invoice->status])); ?></span>
                                                            <?php elseif($invoice->status == 4): ?>
                                                                <span
                                                                    class="p-2 px-3 rounded badge bg-success"><?php echo e(__(\App\Models\Invoice::$statues[$invoice->status])); ?></span>
                                                            <?php endif; ?>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php if($bill->status == 0): ?>
                                                                <span
                                                                    class="p-2 px-3 rounded badge bg-secondary"><?php echo e(__(\App\Models\Bill::$statues[$bill->status])); ?></span>
                                                            <?php elseif($bill->status == 1): ?>
                                                                <span
                                                                    class="p-2 px-3 rounded badge bg-warning"><?php echo e(__(\App\Models\Bill::$statues[$bill->status])); ?></span>
                                                            <?php elseif($bill->status == 2): ?>
                                                                <span
                                                                    class="p-2 px-3 rounded badge bg-danger"><?php echo e(__(\App\Models\Bill::$statues[$bill->status])); ?></span>
                                                            <?php elseif($bill->status == 3): ?>
                                                                <span
                                                                    class="p-2 px-3 rounded badge bg-info"><?php echo e(__(\App\Models\Bill::$statues[$bill->status])); ?></span>
                                                            <?php elseif($bill->status == 4): ?>
                                                                <span
                                                                    class="p-2 px-3 rounded badge bg-success"><?php echo e(__(\App\Models\Bill::$statues[$bill->status])); ?></span>
                                                            <?php endif; ?>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                                            ...
                                                            <div class="progress mb-0">
                                                                <?php if($per<=33): ?>
                                                                    <div class="progress-bar bg-danger"
                                                                         style="width: <?php echo e($per); ?>%"></div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\~Prgoramming\Projects\Laravel\Mini Projects\erpgo - permissions\resources\views/dashboard/account-dashboard.blade.php ENDPATH**/ ?>